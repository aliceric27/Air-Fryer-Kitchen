...
$(document).ready(function () {
  ...
  $("#email").click(function () {
    ...
    $(".tooltiptext").html(
      '<i class="fa-solid fa-check" style="color:green;"></i>已複製'
    );
    toastr.options = {
      closeButton: false,
      debug: false,
...
const labels3 = ["每日建議", "慢烤味噌魚", "大紅袍滷雞腿", "炙燒明太子雞腿"];
...
const myChart = new Chart(document.getElementById("foodChart-1"), config);

const myChart2 = new Chart(document.getElementById("foodChart-2"), config2);

const myChart3 = new Chart(document.getElementById("foodChart-3"), config3);
let isclick = true;
